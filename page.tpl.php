		...
		<div id="container">
			...
			<div id="containerPage">
				<?php if ($leftsidebar): ?>
					...
					<div id="leftSidebar">' . $leftsidebar . '</div><!--leftSidebar-->'; ?>
				<?php endif; ?>
...
/*$('.program-image .view-content').cycle({ 
    fx:     'fade', 
    speed:  'slow', 
    timeout: 0, 
    next:	'#next',
...
function onAfter(){$('.program-image .nav').removeClass('hidden');}*/
//Creating qTips
...
$(document).ready(function() 
    { 
        ...
        $(".program-list table.views-table").tablesorter({textExtraction: "complex"});  
});
</script>
